...
$candidatesArray = $candidates->getCandidateNames($dataName, 'candidate.first_name', 'ASC');
...
$output =
    ...
    "    <totalelements>" . count($candidatesArray) . "</totalelements>\n";

$arrayCounter = 0;
foreach ($candidatesArray as $rowIndex => $row)
{
    $arrayCounter++;
