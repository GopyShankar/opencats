...
class TemplateUtility
{
    ...
    public static function printHeaderBlock($showTopRight = true)
    {
        ...
        if ($showTopRight)
        {
            ...
            if (isset($systemInfoData['available_version']) &&
                ...
                $_SESSION['CATS']->getAccessLevel(ACL::SECOBJ_ROOT) >= ACCESS_LEVEL_SA)
            {
                // echo '<a href="http://www.catsone.com/download.php" target="catsdl">A new CATS version is available!</a><br />'; //commented by gopy
            }
    ...
    private static function _printCommonHeader($pageTitle, $headIncludes = array())
    {
        ...
        echo '<head>', "\n";
        echo '<title>VHS Consulting - ', $pageTitle, '</title>', "\n";
        echo '<meta http-equiv="Content-Type" content="text/html; charset=', HTML_ENCODING, '" />', "\n";
        echo '<link rel="icon" href="/images/temp/favicon.ico" type="image/x-icon" />', "\n";
        echo '<link rel="shortcut icon" href="/images/temp/favicon.ico" type="image/x-icon" />', "\n";
