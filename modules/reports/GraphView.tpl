...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        ...
        <link rel="icon" href="/images/temp/favicon.ico" type="image/x-icon" />
        <link rel="shortcut icon" href="/images/temp/favicon.ico" type="image/x-icon" />
    ...
    <body style="background: #fff;">
        <div class="outer">
            ...
            <span id="footerCopyright">&copy;2021 VHS Consulting Pvt Ltd. All rights reserved.</span></p>
        </div>
    </body>
</html>
