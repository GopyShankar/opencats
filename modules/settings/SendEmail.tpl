        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Settings: Send E-mail</h2></td>
                </tr>
            </table>
            ...
            <table class="editTable" width="100%">
                <tr>
                    <td>
                        <form name="jobIDForm" id="jobIDForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=sendMail" method="post" autocomplete="off" enctype="multipart/form-data">
                            <input type="hidden" name="postback" id="postback" value="jobID" />
                            <table>
                                <tr>
                                    <td class="tdVertical" style="text-align: right;">
                                        <label id="jobOrderLabel" for="type">JD:</label>
                                    </td>
                                    <td class="tdData">
                                        <select tabindex="7" id="jobID" name="jobID" class="inputbox" onchange="getJobData()" style="width: 600px;">
                                            <option value="" disabled="" selected="">Selected</option>
                                        <?php foreach($this->jobOrdersTitle as $jobTitle): ?>
                                            <option value="<?php echo $jobTitle['joborder_id'] ?>" 
                                                    <?php if(isset($this->selectedJob) && $this->selectedJob == $jobTitle['joborder_id']) echo('selected'); ?> >
                                                    <?php echo $jobTitle['title'];?>
                                            </option>
                                        <?php endforeach; ?>
                                        </select>&nbsp;
                                    </td>
                        ...
                        <form name="emailForm" id="emailForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=sendMail" method="post" onsubmit="return checkEmailTo(document.emailForm);" autocomplete="off" enctype="multipart/form-data">
                        <input type="hidden" name="postback" id="postback" value="postback" />
                        <table>
                            <tr>
                                <td class="tdVertical" style="text-align: right;">
                                    <label id="emailToLabel" for="emailTo">To</label>
                                </td>
                                <td class="tdData">
                                    <textarea class="inputbox" name="emailTo" id="emailTo" rows="2", cols="90" tabindex="99" style="width: 600px;"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td class="tdVertical" style="text-align: right;">
