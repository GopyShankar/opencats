        ...
        <div id="contents"<?php echo !$this->numActivities ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td><h2>Offer Letter Mail Activities</h2></td>
                    <td align="right">
            ...
            <p class="note">
                <span style="float:left;">Offer Letter Mail Activities - Page <?php echo($this->dataGrid->getCurrentPageHTML()); ?></span>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="956">
                ...
                <td style="padding-left: 62px;" align="center" valign="center">
                    ...
                    Offer Letter Mail Activities are automatically recorded based on actions you perform.
                    </div>
                </td>
